...
pub use binbook_diagnostic_protocol::{
    ...
    EVT_GRAY_OVERLAY_START, EVT_IDLE_ENTERED, EVT_IDLE_LEFT, EVT_IDLE_SUMMARY, EVT_KEY_PRESS,
    EVT_PAGE_DECISION, EVT_PAGE_TURN, EVT_PANEL_MODE, EVT_REFRESH_DECISION, EVT_REFRESH_PHASE,
    EVT_RENDER_FAILURE, EVT_RENDER_START, EVT_RENDER_SUCCESS, EVT_RESEED_COMPLETE,
    EVT_RESEED_START, EVT_TURN_DEQUEUED, EVT_TURN_DROPPED, EVT_TURN_QUEUED, EVT_WAVEFORM_SELECTED,
};
