...
pub use binbook_diagnostic_protocol::{
    ...
    EVT_FIRMWARE_STARTED, EVT_IDLE_ENTERED, EVT_IDLE_LEFT, EVT_IDLE_SUMMARY, EVT_KEY_PRESS,
    EVT_PAGE_DECISION, EVT_PAGE_TURN, EVT_PANEL_MODE, EVT_REFRESH_DECISION, EVT_RENDER_FAILURE,
    EVT_RENDER_START, EVT_RENDER_SUCCESS,
};
