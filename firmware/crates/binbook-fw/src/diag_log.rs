...
pub use binbook_diagnostic_protocol::{
    EVT_ADC_SAMPLE, EVT_BUSY_WAIT_END, EVT_BUSY_WAIT_START, EVT_BUTTON_EVENT,
    EVT_BW_BASE_SYNC_CANCELLED, EVT_BW_BASE_SYNC_COMPLETE, EVT_BW_BASE_SYNC_START, EVT_CMD_ERROR,
    EVT_CMD_RECEIPT, EVT_CONTROLLER_RAM_STATE, EVT_DISPLAY_ERROR, EVT_DISPLAY_RECOVERY,
    EVT_DISPLAY_REQUEST_END, EVT_DISPLAY_REQUEST_START, EVT_FIRMWARE_STARTED,
    EVT_GRAY_DELAY_CANCELLED, EVT_GRAY_OVERLAY_ACTIVATE, EVT_GRAY_OVERLAY_CANCELLED,
    EVT_GRAY_OVERLAY_COMPLETE, EVT_GRAY_OVERLAY_START, EVT_IDLE_ENTERED, EVT_IDLE_LEFT,
    EVT_IDLE_SUMMARY, EVT_INPUT_DECISION, EVT_INPUT_TRANSITION, EVT_KEY_PRESS, EVT_PAGE_DECISION,
    EVT_PAGE_METADATA_READ, EVT_PAGE_TURN, EVT_PANEL_MODE, EVT_PLANE_ROW_FILL_SUMMARY,
    EVT_PLANE_SPI_WRITE_SUMMARY, EVT_PLANE_WRITE_END, EVT_PLANE_WRITE_START, EVT_REFRESH_DECISION,
    EVT_REFRESH_PHASE, EVT_REFRESH_TRIGGER, EVT_RENDER_FAILURE, EVT_RENDER_START,
    EVT_RENDER_SUCCESS, EVT_REQUEST_ENQUEUE, EVT_REQUEST_RECEIVE, EVT_RESEED_COMPLETE,
    EVT_RESEED_START, EVT_TURN_BOUNDARY_NOOP, EVT_TURN_DEQUEUED, EVT_TURN_DROPPED, EVT_TURN_QUEUED,
    EVT_TURN_STARTED, EVT_WAVEFORM_SELECTED,
};
