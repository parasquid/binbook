...
pub use binbook_diagnostic_protocol::{
    ...
    EVT_PAGE_TURN, EVT_PANEL_MODE, EVT_REFRESH_DECISION, EVT_REFRESH_PHASE, EVT_RENDER_FAILURE,
    EVT_RENDER_START, EVT_RENDER_SUCCESS, EVT_REQUEST_ENQUEUE, EVT_REQUEST_RECEIVE,
    EVT_RESEED_COMPLETE, EVT_RESEED_START, EVT_TURN_BOUNDARY_NOOP, EVT_TURN_DEQUEUED,
    EVT_TURN_DROPPED, EVT_TURN_QUEUED, EVT_TURN_STARTED, EVT_WAVEFORM_SELECTED,
};
